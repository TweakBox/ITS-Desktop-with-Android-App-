...
/**
 * Created by TweakBox on 23/09/2016.
 */
public class FetchHandoutScript extends AsyncTask<String, Void, String> {

    private SubjectInfo _caller;
    FetchHandoutScript(SubjectInfo caller) { _caller = caller; }
    private String type;
